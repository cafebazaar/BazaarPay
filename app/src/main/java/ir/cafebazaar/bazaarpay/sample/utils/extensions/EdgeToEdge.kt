...
/**
 * This class is copied from appcompat 1.7.1 to prevent update minSdk to 21
 */
...
import ir.cafebazaar.bazaarpay.sample.utils.extensions.SystemBarStyle.Companion.dark
import ir.cafebazaar.bazaarpay.sample.utils.extensions.SystemBarStyle.Companion.light
...
@JvmName("enable")
@JvmOverloads
internal fun ComponentActivity.enableEdgeToEdge(
